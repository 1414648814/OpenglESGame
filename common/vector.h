...
Copyright (C) 2011 Romain Marucchi-Foino http://glesbook.sio2interactive.com
...
/*!
	...
	\brief Function prototypes and definitions to use with vec2, vec3 and vec4 structures.
*/
